...
%left			TOK_PUISSANCE	/* ^ */
%left			TOK_ET		TOK_OU		TOK_NOPE		/* et ou non */
...
/*
exemple : recette test : monEntier = 4; ;
*/
fonction:  TOK_FONCTION variable_texte TOK_DOUBLE_POINT bloc_code TOK_FINSTR{
              $$=g_node_new((gpointer)METHODEVOID);
              g_node_append($$,$2);
							g_node_append($$,$4);
          };
appelFonction: TOK_APPEL variable_texte TOK_FINSTR{
								$$=g_node_new((gpointer)APPELMETHODE);
								g_node_append($$,$2);
							};
...
affichage:	TOK_COOKIE expression_arithmetique TOK_FINSTR{
